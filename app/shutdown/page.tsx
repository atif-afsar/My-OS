...
import { Moon, Star, ArrowLeft, ArrowRight, Check, Home, Sparkles, CheckSquare, Clock, Plus, Trash2, Calendar, ClipboardList } from "lucide-react";
  ...
  async function loadPendingTasks() {
    ...
    try {
      ...
      if (Array.isArray(data)) {
        ...
        const pending = data.filter((t: Task) => t.status !== "Completed");
...
${tomorrowTasks.length > 0
    ...
    return (
      <div className="flex flex-col gap-6 py-4">
        <PageHeader
          ...
          description="Synthesizing today's tasks and preparations..."
          icon={Moon}
  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      ...
      <PageHeader
        title="Evening Shutdown"
        description="Close the day, plan tomorrow, and clear your mind."
        icon={Moon}
